...
const messages = {
  en: {
    ...
    workbench: {
      ...
      modeA: 'Plan A: Pure LLM',
      modeB: 'Plan B: RAG+Self-Heal',
      modeC: 'Plan C: Agent',
      selectModeHint: 'Click a plan button above to start.',
      stepGenerate: 'Generating',
      stepExecute: 'Executing',
    ...
    agentTrace: {
      ...
      hint: 'Real-time visualization of the Agent\'s thinking, planning, tool calls, and observations.',
      empty: 'Click "Agent Run" to start and see the live reasoning trace here.',
      waiting: 'Connecting to Agent stream…',
      streaming: 'Streaming',
      clear: 'Clear',
      step: 'Step',
      intent: 'Intent',
      ...
      planStepComplete: 'Plan step #{n} done',
      ...
      agentStopped: 'Agent run stopped.',
      agentCleared: 'Agent trace cleared.',
      eventTypes: {
        task_analysis: 'Task Analysis',
        plan: 'Execution Plan',
        thinking: 'Thinking',
        action: 'Action',
        plan_step_complete: 'Plan Step Done',
        finish: 'Finish',
        error: 'Error',
        summary: 'Summary',
      },
  ...
  'zh-CN': {
    ...
    agentTrace: {
      title: 'Agent 推理轨迹',
      hint: '实时展示 Agent 的思考、规划、工具调用与观察结果。',
      empty: '点击「Agent 运行」开始，这里将实时显示推理轨迹。',
      waiting: '正在连接 Agent 流…',
      streaming: '推送中',
      clear: '清除',
      step: '步骤',
      intent: '意图',
      ...
      agentRun: 'Agent 运行',
      agentStop: '停止 Agent',
      agentRunStarted: 'Agent 运行已启动。',
      agentRunFailed: 'Agent 运行失败。',
      agentStopped: 'Agent 运行已停止。',
      agentCleared: 'Agent 轨迹已清除。',
      eventTypes: {
        task_analysis: '任务分析',
        plan: '执行计划',
        thinking: '思考',
        action: '动作',
        plan_step_complete: '计划步骤完成',
        finish: '完成',
        error: '错误',
        summary: '汇总',
      },
